...
These commands should be in the following format, where the dApp alias (assigned to you by API3 during [registration](../oev-rewards/index.md#how-to-get-onboard)), chain ID, and dAPI names match your case:
